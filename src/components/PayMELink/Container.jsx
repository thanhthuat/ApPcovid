...
import BoxSearchPaymentLink from './BoxSearchPayMELink';
import DataTablePaymentLink from './DataTablePayMELink';
...
export default function PaymentLink() {
  ...
  const handleClickFilter = (value) => {
    ...
    switch (value) {
      ...
      case 'highest_deaths':
        dataBuffer.sort((a, b) => {
          return a.TotalDeaths < b.TotalDeaths ? 1 : -(a.TotalDeaths > b.TotalDeaths);
        });
  ...
  return (
    <div className='countryContainer'>
      <HeaderPaymentLink toggleFilter={toggleFilter} showFilter={showFilter} />
      {showFilter ? <BoxSearchPaymentLink handleClickFilter={handleClickFilter} /> : null}
      <DataTablePaymentLink data={dataContry} handleShowModal={handleShowModal} />
